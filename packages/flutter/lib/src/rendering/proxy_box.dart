...
class RenderShaderMask extends RenderProxyBox with RositaRenderShaderMaskMixin {
...
class RenderFractionalTranslation extends RenderProxyBox with RositaRenderFractionalTranslationMixin {
  ...
  @override
  void applyPaintTransform(RenderBox child, Matrix4 transform) {
    if (translation.dx == 0 && translation.dy == 0) return;
...
///    [RenderMouseRegion].
class RenderMouseRegion extends RenderProxyBoxWithHitTestBehavior with RositaSkipRenderObjectMixin
...
class RenderSemanticsAnnotations extends RenderProxyBox with SemanticsAnnotationsMixin, RositaSkipRenderObjectMixin {
