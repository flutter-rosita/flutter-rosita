...
class _RenderDecoration extends RenderBox
    with SlottedContainerRenderObjectMixin<_DecorationSlot, RenderBox>, RositaCanvasMixin, RositaPaintRenderObjectMixin {
  _RenderDecoration({
  ...
  Widget build(BuildContext context) {
    ...
    final Widget? prefix = hasPrefix
        ? _AffixText(
            ...
            style:
                MaterialStateProperty.resolveAs(decoration.prefixStyle, materialState) ?? hintStyle,
    ...
    final Widget? suffix = hasSuffix
        ? _AffixText(
            ...
            style:
                MaterialStateProperty.resolveAs(decoration.suffixStyle, materialState) ?? hintStyle,
    ...
    if (input != null && needsSemanticsSortOrder) {
      input = RositaSemantics(sortKey: _inputSemanticsSortOrder, child: input);
    }
              ...
              child: ConstrainedBox(
                ...
                child: IconTheme.merge(
                  ...
                  child: IconButtonTheme(
                    ...
                    child: RositaSemantics(child: decoration.prefixIcon),
                  ),
                ),
              ),
            ),
              ...
              child: ConstrainedBox(
                ...
                child: IconTheme.merge(
                  ...
                  child: IconButtonTheme(
                    ...
                    child: RositaSemantics(child: decoration.suffixIcon),
                  ),
                ),
              ),
            ),
...
class InputDecorationThemeData with Diagnosticable {
  ...
  void debugFillProperties(DiagnosticPropertiesBuilder properties) {
    super.debugFillProperties(properties);
    const InputDecorationThemeData defaultTheme = InputDecorationThemeData();
    properties.add(
