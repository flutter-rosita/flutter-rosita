...
class SurfaceSceneBuilder implements ui.SceneBuilder {
  ...
  @override
  ui.ClipRSuperellipseEngineLayer pushClipRSuperellipse(ui.RSuperellipse rsuperellipse, {required ui.Clip clipBehavior, ui.ClipRSuperellipseEngineLayer? oldLayer}) {
    // TODO: implement pushClipRSuperellipse
    throw UnimplementedError();
  }
}
